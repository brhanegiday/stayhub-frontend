            ...
            <div className="text-center space-y-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold mb-2">
                        {isConfirmed ? "Booking Confirmed!" : isPending ? "Booking Request Sent" : "Booking Cancelled"}
                    </h1>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-sm text-muted-foreground">
                                                {booking.pricing?.nights || booking.numberOfNights || 1}{" "}
                                                {(booking.pricing?.nights || booking.numberOfNights || 1) === 1
                                                    ? "night"
                                                    : "nights"}
                                            </div>
                                        </div>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="p-4 bg-muted/50 rounded-lg">
                                    <p className="text-sm">
                                        Check-in time: {booking.property?.checkInTime || "3:00 PM"}. Please contact the
                                        host upon arrival.
                                    </p>
                                </div>
                            </CardContent>
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-muted-foreground">
                                        ...
                                        {format(
                                            new Date(
                                                booking.cancellationPolicy?.freeCancellationUntil || booking.checkInDate
                                            ),
                                            "MMM d, yyyy"
                                        )}
                                    </div>
                            ...
                            <div className="text-sm text-muted-foreground">
                                <p>
                                    ...
                                    {booking.cancellationPolicy?.refundPercentage || 50}% refund up to 5 days before
                                    check-in.
                                </p>
                            </div>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-3">
                            <div className="flex justify-between">
                                <span>
                                    ${booking.pricing?.basePrice || Math.floor(booking.totalPrice * 0.8)} ×{" "}
                                    {booking.pricing?.nights || booking.numberOfNights || 1} nights
                                </span>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex items-center space-x-3">
                                <Avatar>
                                    <AvatarImage
                                        src={booking.property?.host?.avatar || booking.host?.avatar}
                                        alt={booking.property?.host?.name || booking.host?.name}
                                    />
                                    <AvatarFallback>
                                        {(booking.property?.host?.name || booking.host?.name || "Host")
                                            .split(" ")
                                            .map((n) => n[0])
                                            .join("")}
                                    </AvatarFallback>
